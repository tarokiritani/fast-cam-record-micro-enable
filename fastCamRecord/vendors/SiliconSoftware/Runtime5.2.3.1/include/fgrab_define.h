...
/**
 * \brief definitions for FG_GBE_CAMTYPE
 */
#define RGB8_PACKED 0
#define BGR8_PACKED 1
#define RGBA8_PACKED 2
#define BGRA8_PACKED 3
...
#define FG_CAMSTATUS_EXTENDED 2050 /**< returns the status information of a particular camera link chip: Bit 0 - Clock, Bit 1: LVAL, Bit 2: FVAL */
...
#define FG_DIGIO_OUTPUT            14020 /**< Set teh state of digital outputs of the frame grabber*/
...
enum Fg_Info_Selector {
	...
	INFO_BITSTREAM_ID                           = 1201, /**< get the bitstream id for the design of the according board identified by param1 as string*/
...
/*
 * \brief Asnychronous notifications
 */
enum {
