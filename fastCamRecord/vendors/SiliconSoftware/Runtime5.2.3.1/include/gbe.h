...
int Gbe_DumpCameraParameters(struct CameraHandle *cameraHandle, const char* paramFileName, uint32_t flags);
int Gbe_ApplyCameraParameters(struct CameraHandle *cameraHandle, const char* paramFileName, uint32_t flags);
